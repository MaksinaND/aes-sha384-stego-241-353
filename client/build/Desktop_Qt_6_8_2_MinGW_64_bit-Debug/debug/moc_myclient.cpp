...
static constexpr auto qt_meta_stringdata_ZN8MyClientE = QtMocHelpers::stringData(
    "MyClient",
    "onConnected",
    "",
    "onReadyRead",
...
Q_CONSTINIT static const uint qt_meta_data_ZN8MyClientE[] = {
...
Q_CONSTINIT const QMetaObject MyClient::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN8MyClientE.offsetsAndSizes,
    qt_meta_data_ZN8MyClientE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN8MyClientE_t,
        // Q_OBJECT / Q_GADGET
...
void *MyClient::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN8MyClientE.stringdata0))
